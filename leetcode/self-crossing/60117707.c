// title: self-crossing
// detail: https://leetcode.com/submissions/detail/60117707/
// datetime: Wed Apr 27 10:35:42 2016
// runtime: 0 ms
// memory: N/A
...
void nextPoint(int i, int metres, int* x, int* y){
    switch(i % 4){
        case 0:
            // move to north
            *y += metres;
