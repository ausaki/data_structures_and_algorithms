...
# detail: https://leetcode.com/submissions/detail/394248472/
# datetime: Sat Sep 12 00:13:01 2020
# runtime: 452 ms
# memory: 21.5 MB
...
class Solution:
    def minPushBox(self, grid: List[List[str]]) -> int:
        ...
        while q:
            ...
            for di, dj in dij:
                pii, pjj = pi + di, pj + dj
                if 0 <= pii < m and 0 <= pjj < n and grid[pii][pjj] != '#':
                    if pii == bi and pjj == bj:
                        bii, bjj = bi + di, bj + dj
                        if 0 <= bii < m and 0 <= bjj < n and grid[bii][bjj] != '#':
                            st = (pii, pjj, bii, bjj)
