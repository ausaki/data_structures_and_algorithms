...
# detail: https://leetcode.com/submissions/detail/190862631/
# datetime: Wed Nov 21 14:54:57 2018
# runtime: 48 ms
# memory: N/A
...
class Solution:
    ...
    def maxProfit3(self, prices):
        ...
        while i < length - 1:
            ...
            i += 1
        return max_profit
    """maxProfit2 和 maxProfit3是看了Solution才想到的。maxProfit1已经很接近Solution的方法了。"""